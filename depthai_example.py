'''
Runs the main loop for the DepthAI object detection pipeline and visualizes boxes. 
'''
...
# parse config
configPath = Path("result/model_13november202418_42.json")
...
# get model path
nnPath = "result/model_13november202418_42_openvino_2022.1_6shave.blob"
...
# Configure and link the spatial detection network
